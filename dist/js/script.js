    ...
    window.tram = (function (t) {
      ...
      var l = (function (t, e, n) {
        ...
        L = function (t) {
          ...
          for (e = 0; e < R.length; e++)
            if ((n = R[e] + i) in T.style) return { dom: n, css: C[e] + t };
        },
        I = (e.support = {
          ...
          c.preview =
            function () {
              if (
                ...
                return;
              a.each(A), _(), i.resize.on(O);
            }),
          (c.destroy = function () {
            (E = t()), _(), a && a.length && a.each(T);
          });
      ...
      (t.exports = function (t, e) {
        ...
        function k(e, n) {
          ...
          r.el.off(h),
            ...
            E(r),
            s
              ? (r.el.on("setting" + h, I(r)), L(r), (r.hasTimer = !1))
              : (r.el.on("swipe" + h, I(r)),
                r.left.on("click" + h, T(r)),
                r.right.on("click" + h, R(r)),
                r.left.on("keydown" + h, A(r, T)),
                r.right.on("keydown" + h, A(r, R)),
                r.nav.on("keydown" + h, "> div", I(r)),
                r.config.autoplay &&
                  !r.hasTimer &&
